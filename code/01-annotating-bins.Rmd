...
for (i in 1:nrow(mar_bins)){
  ...
  small_fa <- all[index]
  writeXStringSet(small_fa, paste0("~/github/jordan-marinimicrobia/data/Bin_fa/", bin), format = "fasta")
}
```

```{bash}
busco -i ~/github/jordan-marinimicrobia/data/Bin_fa -m geno -o ~/github/jordan-marinimicrobia/output/busco_outputs -c 8 --auto-lineage
```
